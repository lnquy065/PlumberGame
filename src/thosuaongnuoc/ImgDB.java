...
public class ImgDB {
    private ClassLoader c=this.getClass().getClassLoader();
    
    private static File dir[] = {
        new File("src\\img\\button\\"),
        new File("src\\img\\label\\"),
        new File("src\\img\\bgnd\\"),
    ...
    private static HashMap<String, HashMap<String, ImageIcon>> imgData = new HashMap<String, HashMap<String, ImageIcon>>();
